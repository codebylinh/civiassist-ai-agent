...
def _check_groq():
    if not config.GROQ_API_KEY:
        ...
        console.print("Get a free key at [bold]https://console.groq.com[/bold]")
        console.print("Then add to .env:  GROQ_API_KEY=gsk_...")
        sys.exit(1)
...
def _print_welcome(agent):
    ...
    console.print(Panel.fit(
        ...
        f"Model: [yellow]{config.MODEL} (Groq)[/yellow]  |  "
